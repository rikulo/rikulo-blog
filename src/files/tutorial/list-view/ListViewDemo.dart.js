...
$$.MatchImplementation = {"":
 ["_groups", "_lib4_end?", "_lib4_start", "str", "pattern?"],
 super: "Object",
...
$$.ListViewDemo = {"":
 ...
 onCreate_$0: function() {
  var t1 = ({});
  this.set$title('ListView Demo');
  t1.view_1 = null;
  t1.view_1 = $.ScrollView$($.CTC43, new $.ListViewDemo_onCreate__anon(t1), null);
  t1.view_1.get$profile().set$text('location: center center; width: 80%; height: 80%');
  $.add$1(t1.view_1.get$classes(), 'list-view');
  for (var x = 0; x < 50; ++x) {
    var child = $.TextView$('Row ' + $.S(x + 1));
    $.add$1(child.get$classes(), 'list-item');
    child.get$style().set$cssText('line-height: 50px');
    child.get$style().set$userSelect('none');
    child.get$profile().set$width('flex');
    child.set$top(x * 50);
    child.set$height(50);
    t1.view_1.addChild$1(child);
  }
  this.get$mainView().addChild$1(t1.view_1);
 }
};
...
$$.FilteredElementList = {"":
 ...
 set$length: function(newLength) {
  ...
  if ($.ltB(newLength, 0)) throw $.captureStackTrace($.CTC54);
...
$$._OnDemandMap = {"":
 ...
 getValues$0: function() {
  var t1 = this._lib8_map;
  return !(t1 == null) ? t1.getValues$0() : $.CTC60;
 },
 getKeys$0: function() {
  var t1 = this._lib8_map;
  return !(t1 == null) ? t1.getKeys$0() : $.CTC60;
 },
 forEach$1: function(f) {
  var t1 = this._lib8_map;
...
$$.View = {"":
 ["_dataAttrs!", "_childInfo?", "_virtIS=", "_prevSibling=", "_nextSibling=", "_lib6_parent!", "_id?"],
 super: "Object",
 toString$0: function() {
 ...
 _addToDoc$6: function(node, outer, inner, before, keepId, location$) {
  var t1 = outer === true;
  if (t1 && (keepId === true && $.isEmpty(node.get$id()) !== true)) this._lib6_uuid = node.get$id();
 ...
 get$uuid: function() {
  if (this._lib6_uuid == null) {
    var t1 = $.View__uuidNext;
    $.View__uuidNext = $.add(t1, 1);
    this._lib6_uuid = $.StringUtil_encodeId(t1, $.viewConfig.get$uuidPrefix());
  }
  return this._lib6_uuid;
 },
...
$$._WCIterator = {"":
 ...
 next$0: function() {
  ...
  this._lib6_next = t1.get$nextSibling();
  return t1;
 },
 hasNext$0: function() {
 ...
 _WCIterator$1: function(owner) {
  this._lib6_next = owner.get$firstChild();
 }
};
...
$$._EventListenerInfo = {"":
 ...
 add$2: function(type, listener) {
  var t1 = ({});
  if (listener == null) throw $.captureStackTrace($.CTC47);
...
$$.Section = {"":
 ["_fellows", "_inDoc", "_hidden", "_layout", "_profile", "_height", "_width", "_lib6_top", "_left", "_node", "_style", "_classes", "_mntAttrs", "_dataAttrs", "_evlInfo", "_childInfo", "_virtIS", "_prevSibling", "_nextSibling", "_lib6_parent", "_lib6_uuid", "_id"],
 super: "View",
 get$domTag_: function() {
  return 'section';
 },
...
$$.TextView = {"":
 ["_html", "_text", "_inDoc", "_hidden", "_layout", "_profile", "_height", "_width", "_lib6_top", "_left", "_node", "_style", "_classes", "_mntAttrs", "_dataAttrs", "_evlInfo", "_childInfo", "_virtIS", "_prevSibling", "_nextSibling", "_lib6_parent", "_lib6_uuid", "_id"],
 super: "View",
 toString$0: function() {
...
$$.ScrollView = {"":
 ["_contentSize", "_contentSizeValue", "_scroller", "direction", "_snap", "_inDoc", "_hidden", "_layout", "_profile", "_height", "_width", "_lib6_top", "_left", "_node", "_style", "_classes", "_mntAttrs", "_dataAttrs", "_evlInfo", "_childInfo", "_virtIS", "_prevSibling", "_nextSibling", "_lib6_parent", "_lib6_uuid", "_id"],
 super: "View",
 insertChildToDocument_$3: function(child, childInfo, beforeChild) {
...
$$.ViewEvent = {"":
 ...
 ViewEvent$6: function(type, target, pageX, pageY, offsetX, offsetY) {
  if (type == null) throw $.captureStackTrace($.CTC44);
  this.currentTarget = target;
  this.target = target;
...
$$._BroadcastListeners = {"":
 ["_lib2_listeners", "_lib2_owner"],
 super: "Object",
 send$2: function(event$, type) {
  if (type == null) type = event$.get$type();
  var ls = $.index(this._lib2_listeners, type);
  if (!(ls == null)) {
...
$$._TouchDragGesture = {"":
 ["_pgy=", "_pgx=", "_elEnd", "_elMove", "_elStart", "_snapTime", "_snapY", "_snapX", "_transform", "_state", "_movement", "_fnRange", "_move", "_end", "_start", "_handle", "_lib3_owner"],
 super: "_DragGesture",
...
$$._MouseDragGesture = {"":
 ["_captured", "_elEnd", "_elMove", "_elStart", "_snapTime", "_snapY", "_snapX", "_transform", "_state", "_movement", "_fnRange", "_move", "_end", "_start", "_handle", "_lib3_owner"],
 super: "_DragGesture",
 _unlisten$0: function() {
...
$$._BoundedInertialMotion = {"":
 ["_snapTo", "_snapMotion", "_vel", "_lib3_pos", "_lib3_snap", "_end?", "_move?", "range?", "snapSpeedThreshold", "bounce", "friction", "element?", "_ver?", "_hor?", "data", "_stateFlag", "_lib5_state", "_lib5_task", "_lib5_end", "_lib5_move", "_lib5_start"],
 super: "Motion",
...
$$.Motion = {"":
 ["_stateFlag=", "_lib5_state=", "_lib5_end?", "_lib5_move?"],
 super: "Object",
 isPaused$0: function() {
  return $.eq(this._stateFlag, 2);
 },
 stop$0: function() {
  $._getAnimator().remove$1(this._lib5_task);
  this._lib5_state = null;
  this._stateFlag = 0;
 },
 run$0: function() {
  switch (this._stateFlag) {
    ...
    case 2:
      ...
      break;
    case 0:
      $.add$1($._getAnimator(), this._lib5_task);
  }
 },
 ...
 onEnd$1: function(state) {
  !(this.get$_lib5_end() == null) && this._lib5_end$1(state);
 },
 get$onEnd: function() { return new $.BoundClosure(this, 'onEnd$1'); },
 onMove$1: function(state) {
  return this.get$_lib5_move() == null || this._lib5_move$1(state) === true;
 },
 get$onMove: function() { return new $.BoundClosure(this, 'onMove$1'); },
 onStart$1: function(state) {
  !(this._lib5_start == null) && this._lib5_start$1(state);
 },
 _lib5_end$1: function(arg0) { return this._lib5_end.$call$1(arg0); },
 _lib5_end$0: function() { return this._lib5_end.$call$0(); },
 _lib5_move$2: function(arg0, arg1) { return this._lib5_move.$call$2(arg0, arg1); },
 _lib5_move$1: function(arg0) { return this._lib5_move.$call$1(arg0); },
 _lib5_start$1: function(arg0) { return this._lib5_start.$call$1(arg0); },
 Motion$4: function(start, move, end, autorun) {
  this._lib5_task = new $.anon2(this);
...
$$.LinearPathMotion = {"":
 ["_lib5_pos", "_diff", "destination", "origin", "_moveCB", "element?", "duration", "mode", "easing", "action", "data", "_stateFlag", "_lib5_state", "_lib5_task", "_lib5_end", "_lib5_move", "_lib5_start"],
 super: "EasingMotion",
 doAction_$2: function(x, state) {
  this._lib5_pos = $.add($.mul(this._diff, x), this.origin);
  var t1 = $.CSS_px(this._lib5_pos.get$left());
  var t2 = this.element;
  t2.get$style().set$left(t1);
  t1 = $.CSS_px(this._lib5_pos.get$top());
  t2.get$style().set$top(t1);
  if (this._moveCB == null) return true;
  var result = this._moveCB$3(state, this._lib5_pos, x);
...
$$.ListViewDemo_onCreate__anon = {"":
 ["box_0"],
 super: "Closure",
 $call$1: function(off) {
  var t1 = this.box_0.view_1.get$innerHeight();
  if (typeof t1 !== 'number') throw $.iae(t1);
  var vlimit = 2500 - t1;
  var y = $.geB(off.get$y(), vlimit) ? vlimit : $.mul($.floor($.div($.add(off.get$y(), 25), 50)), 50);
  return $._Offset$(off.get$x(), y);
 }
};
...
$$.anon2 = {"":
 ...
 $call$2: function(time, elapsed) {
  if ($.eqB(this.this_0.get$_stateFlag(), 0)) {
    ...
    this.this_0.set$_lib5_state(t1);
    t1 = this.this_0;
    t1.onStart$1(t1.get$_lib5_state());
    this.this_0.set$_stateFlag(1);
  }
  this.this_0.get$_lib5_state()._snapshot$2(time, elapsed);
  switch (this.this_0.get$_stateFlag()) {
    case 1:
      if (this.this_0.get$_lib5_state().isPaused$0() === true) {
        this.this_0.get$_lib5_state()._resume$1(time);
        t1 = this.this_0;
        t1.onResume$1(t1.get$_lib5_state());
      }
      t1 = this.this_0;
      var cont = t1.onMove$1(t1.get$_lib5_state());
      if (cont == null) cont = true;
      if (cont !== true) {
        t1 = this.this_0;
        t1.onEnd$1(t1.get$_lib5_state());
        this.this_0.set$_lib5_state(null);
        this.this_0.set$_stateFlag(0);
      }
      return cont;
    case 2:
      if (this.this_0.get$_lib5_state().isPaused$0() !== true) {
        this.this_0.get$_lib5_state()._pause$1(time);
        t1 = this.this_0;
        t1.onPause$1(t1.get$_lib5_state());
      }
      return true;
  }
 }
...
$.StringUtil_encodeXML = function(txt, multiline, maxlength, pre) {
  ...
  if (multiline || t1) {
    ...
    for (enc = null, j = 0, k = 0; j < tl; ++j) {
      t1 = txt.length;
      if (j < 0 || j >= t1) throw $.ioore(j);
      enc = $.CTC51.operator$index$1(txt[j]);
      if (!(enc == null)) {
        $.add$1($.add$1($.add$1(out.add$1($.substring$2(txt, k, j)), '&'), enc), ';');
        k0 = j + 1;
        k = k0;
...
$._ViewImpl_getDOMEventDispatcher = function(type) {
  if ($._ViewImpl__domEvtDisps == null) {
    ...
    for (var t1 = $.iterator($.CTC48); t1.hasNext$0() === true; ) {
      var t2 = t1.next$0();
...
$._Scroller$ = function(owner, _fnViewPortSize, _fnContentSize, handle, direction, scrollbar, snap, start, move, end) {
  var t1 = direction === $.CTC45 || direction === $.CTC46;
  var t2 = direction === $.CTC43 || direction === $.CTC46;
...
$.ListViewDemo$ = function() {
  var t1 = new $.ListViewDemo(null, [], null, '');
  t1.Activity$0();
  return t1;
};
...
$.AnchorRelation_position = function(view, x, y, location$) {
  if (location$ == null || $.isEmpty(location$) === true) {
    ...
    $.index($._anchorXHandlers(), $.index(handlers, 0)).$call$3(x, $.CTC62, view);
    $.index($._anchorYHandlers(), $.index(handlers, 1)).$call$3(y, $.CTC62, view);
  }
};
...
$.dynamicFunction = function(name$) {
  ...
  var methods = ({});
  var dartMethod = (Object.getPrototypeOf($.CTC64)[name$]);
...
$.CSS_name = function(propertyName) {
  if ($.CSS__nsnms == null) {
    ...
    for (t1 = $.iterator($.CTC49); t1.hasNext$0() === true; ) {
      var t2 = t1.next$0();
      $.add$1($.CSS__nsnms, t2);
    }
  }
...
$.getFunctionForTypeNameOf = function() {
  ...
  if ($.contains$1(userAgent, $.CTC63) === true) return $.typeNameInChrome;
...
$.CSSStyleDeclarationImpl__check = function(propertyName) {
  ...
  if ($.startsWith(propertyName, 'margin') === true) throw $.captureStackTrace($.CTC59);
};
    ...
    case 2:
      if (state == 2 || (state == 0 && (multiline || t1))) {
        ...
        for (enc = null, j = 0, k = 0; $.ltB(j, tl); ++j) {
          enc = $.CTC51.operator$index$1($.index(txt, j));
          if (!(enc == null)) {
            $.add$1($.add$1($.add$1(out.add$1($.substring$2(txt, k, j)), '&'), enc), ';');
            k0 = j + 1;
            k = k0;
...
$.CTC50 = Isolate.makeConstantList(['<', '>', '&', '"']);
$.CTC51 = new Isolate.$isolateProperties.ConstantMap(Isolate.$isolateProperties.CTC50, {'<': 'lt', '>': 'gt', '&': 'amp', '"': 'quot'}, 4);
...
$.CTC59 = new Isolate.$isolateProperties.UIException('You can\'t change margin');
...
$.CTC58 = Isolate.makeConstantList(['left', 'top', 'right', 'bottom', 'width', 'height', 'display']);
...
$.CTC52 = new Isolate.$isolateProperties.UnsupportedOperationException('');
...
$.CTC53 = new Isolate.$isolateProperties.NotImplementedException(null);
$.CTC40 = new Isolate.$isolateProperties.JSSyntaxRegExp(false, false, '(msie) ([\\w.]+)');
$.CTC32 = new Isolate.$isolateProperties._AnchorOfRoot();
$.CTC48 = Isolate.makeConstantList(['blur', 'click', 'focus', 'mouseDown', 'mouseMove', 'mouseOut', 'mouseOver', 'mouseUp', 'mouseWheel', 'scroll']);
$.CTC62 = new Isolate.$isolateProperties._AnchorOfPoint();
$.CTC63 = new Isolate.$isolateProperties.JSSyntaxRegExp(false, false, 'Chrome|DumpRenderTree');
$.CTC38 = new Isolate.$isolateProperties.JSSyntaxRegExp(false, false, '(chrome)[ /]([\\w.]+)');
$.CTC43 = new Isolate.$isolateProperties.Dir('vertical');
$.CTC54 = new Isolate.$isolateProperties.IllegalArgumentException('Invalid list length');
...
$.CTC44 = new Isolate.$isolateProperties.UIException('type required');
